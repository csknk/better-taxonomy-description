...
if ( class_exists( 'TermMetaUI' ) ) { return; }
/**
	...
	public function __construct( $file = '' ) {
		...
		foreach ( $this->taxonomies as $value ) {
			...
			if ( true === $this->has_fields ) {
				...
				//add_action( "{$value}_add_form_fields",  array( $form_field, 'add_field'  ) );
				add_action( "{$value}_add_form_fields",  [ new Views\NewFormField(), 'add_field' ]  );

				add_action( "{$value}_edit_form_fields", [ new Views\EditFormField(), 'edit_field' ]  );
			}
		}
